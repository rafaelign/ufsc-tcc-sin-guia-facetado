...
class SeedReferencesTableWithReReferences extends Migration
{
    ...
    public function up()
    {
        DB::table('references')->insert([
            ...
            ['description' => 'REHMAN, T. U., KHAN, M. N. A., and RIAZ, N. “Analysis of Requirement Engineering Processes, Tools/Techniques and Methodologies,” Int. J. Inf. Technol. Comput. Sci., vol. 5, no. 3, pp. 40–48, Feb. 2013'],
